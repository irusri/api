...
{% api-method method="get" host="https://api.plantgenie.org/genelist" path="/get\_all" %}
{% api-method-summary %}
Get all genelists
...
```text
curl --location --request GET 'http://api.plantgenie.org/genelist/get_all?name=testing_only&fingerprint=1072439978&table=genelist_potra'
```
...
{% embed url="https://codepen.io/irusri/pen/GRNYpPR" caption="" %}
